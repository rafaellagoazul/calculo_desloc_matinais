...
print("\n🧠 MAPEAMENTO DO CORE (SOMENTE LEITURA)")
print("📂 Pasta:", CORE_DIR)
...
print(f"\n📄 Arquivos encontrados ({len(py_files)}):")
for f in py_files:
...
for file in py_files:
    try:
        ...
        print(f"⚠️ Erro ao ler {file.name}: {e}")
        continue
...
print("✅ Mapeamento concluído (nenhuma modificação realizada)\n")
